...
public class DanhSachCSVCForm extends javax.swing.JFrame {
    ...
    private void loadDataToTable() {
        ...
        model.setColumnIdentifiers(new String[]{"Mã số", "Tên thiết bị", "Loại thiết bị", "Đơn vị tính", "Số lượng", "Tình trạng"});
        ...
        try (Connection conn = DBConnection.getConnection()) {
            ...
            while (rs.next()) {
                String ma = rs.getString("MaCSVC");
                String ten = rs.getString("TenCSVC");
                String loai = rs.getString("LoaiCSVC");
                String donVi = rs.getString("DonViTinh");
                int soLuong = rs.getInt("SoLuong");
                String tinhTrang = rs.getString("TinhTrang");

                model.addRow(new Object[]{ma, ten, loai, donVi, soLuong, tinhTrang});
            }
    ...
    private void btnUpDateActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if (selectedRow != -1) {
            ...
            String donViTinh = tblCSVC.getValueAt(selectedRow, 3).toString();
            int soLuong = Integer.parseInt(tblCSVC.getValueAt(selectedRow, 4).toString());
            String tinhTrang = tblCSVC.getValueAt(selectedRow, 5).toString();
    ...
    private void btnTimKiemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTimKiemActionPerformed
        ...
        try (Connection conn = DBConnection.getConnection()) {
            String sql = "SELECT * FROM CoSoVatChat WHERE TenCSVC LIKE ?";
            PreparedStatement ps = conn.prepareStatement(sql);
            ...
            while (rs.next()) {
                String maTB = rs.getString("MaCSVC");
                String tenTB = rs.getString("TenCSVC");
                String loaiTB = rs.getString("LoaiCSVC");
